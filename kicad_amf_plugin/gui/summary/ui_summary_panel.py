...
class UiSummaryPanel ( wx.Panel ):
	...
	def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( -1,-1 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
		...
		self.m_panel1 = wx.Panel( self.splitter_detail_summary, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
		sbSizer1 = wx.StaticBoxSizer( wx.StaticBox( self.m_panel1, wx.ID_ANY, _(u"Cost detail") ), wx.VERTICAL )
		...
		self.m_panel2 = wx.Panel( self.splitter_detail_summary, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
		sbSizer41 = wx.StaticBoxSizer( wx.StaticBox( self.m_panel2, wx.ID_ANY, _(u"Order Summary") ), wx.VERTICAL )
		...
		bSizer31.Add( self.btn_BOM_match, 0, wx.ALL|wx.EXPAND, 5 )
